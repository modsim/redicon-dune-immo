...
m4_define([DUNE_AC_INIT],[
  AC_INIT([dune-channeling], [0.2.4], [valiska@fz-juelich.de])
  AM_INIT_AUTOMAKE([foreign 1.9 tar-pax])
  m4_ifdef([AM_SILENT_RULES], [AM_SILENT_RULES([no])])
  AC_SUBST([DUNE_MOD_VERSION], [0.2.4])
  AC_SUBST([DUNE_MOD_NAME], [dune-channeling])
  AC_SUBST([DUNE_MAINTAINER_NAME], ["valiska@fz-juelich.de"])
  DUNE_PARSE_MODULE_VERSION([dune-channeling], [0.2.4])
...
AC_DEFUN([DUNE_CHECK_MOD_DEPENDENCIES], [
  ...
  ### invoke checks for dune-channeling
  AC_REQUIRE([DUNE_CHANNELING_CHECKS])
])
