...
{
	public:
		RobinBC (const Dune::FieldVector<ct, dim+1> & Xo, double Ro, 
				const Dune::FieldVector<ft, fdim> & u, const Dune::FieldMatrix<ft, fdim, fdim> & eta) 
			: Xo(Xo), Ro(Ro), k0(u), k1(eta) 
		{};

		RobinBC (const Dune::FieldVector<ct, dim+1> & Xo, double Ro, const Dune::FieldVector<ft, fdim> & u) 
			: Xo(Xo), Ro(Ro), k0(u), k1(Dune::FieldMatrix<double, fdim,fdim> (0)) 
		{};

		RobinBC (const Dune::FieldVector<ct, dim+1> & Xo, double Ro, const Dune::FieldMatrix<ft, fdim, fdim> & eta) 
			: Xo(Xo), Ro(Ro), k0(Dune::FieldVector<double, fdim> (0)), k1(eta)
		{};
